...
keymap.set("n", "<leader>ss", "<C-w>w") -- split window horizontally
...
keymap.set("n", "j", "jzz") -- center cursor vertically
keymap.set("n", "k", "kzz") -- center cursor vertically
keymap.set("n", "<C-d>", "<C-d>zz") -- center cursor vertically
keymap.set("n", "<C-u>", "<C-u>zz") -- center cursor vertically
